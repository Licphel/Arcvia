...
#define ARC_MOUSE_BUTTON_BEGIN 480
#define ARC_MOUSE_BUTTON_1 (0 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_2 (1 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_3 (2 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_4 (3 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_5 (4 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_6 (5 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_7 (6 + ARC_MOUSE_BUTTON_BEGIN)
#define ARC_MOUSE_BUTTON_8 (7 + ARC_MOUSE_BUTTON_BEGIN)
